          ...
          <div className="rounded-3xl border border-stone-200 bg-white p-6 shadow-xl sm:p-10">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-orange-700 py-3.5 font-semibold text-white transition hover:bg-orange-800 disabled:cursor-not-allowed disabled:opacity-60"
              >
                <UserPlus size={19} />
